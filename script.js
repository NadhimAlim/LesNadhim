...
function generateAdminReply(userMessage) {
  ...
  } else if (lowerCaseMessage.includes("Adakah Nomor Telepon") || lowerCaseMessage.includes("Adakah Nomor WhatsApp")) {
...
document.addEventListener("DOMContentLoaded", function() {
  function animateCountUp(element, start, end, duration) {
    ...
    function step(timestamp) {
      ...
      const current = Math.min(end, Math.floor(start + (end - start) * (progress / duration)));
